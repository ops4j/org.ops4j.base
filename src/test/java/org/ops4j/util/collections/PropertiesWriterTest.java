...
public class PropertiesWriterTest
{
        ...
        throws IOException
    {
        ...
        compareFiles(
            FileUtils.getFileFromClasspath( "org/ops4j/util/collections/newline.ini" ),
            m_file,
            true
        );
    }
        ...
        throws IOException
    {
        ...
        compareFiles(
            FileUtils.getFileFromClasspath( "org/ops4j/util/collections/comment.ini" ),
            m_file,
            true
        );
    }
        ...
        throws IOException
    {
        ...
        compareFiles(
            FileUtils.getFileFromClasspath( "org/ops4j/util/collections/nullcomment.ini" ),
            m_file,
            true
        );
    }
        ...
        throws IOException
    {
        ...
        compareFiles(
            FileUtils.getFileFromClasspath( "org/ops4j/util/collections/validproperty.ini" ),
            m_file,
            true
        );
    }
        ...
        throws IOException
    {
        ...
        compareFiles(
            FileUtils.getFileFromClasspath( "org/ops4j/util/collections/nullvalueproperty.ini" ),
            m_file,
            true
        );
    }
        ...
        throws IOException
    {
        ...
        compareFiles(
            FileUtils.getFileFromClasspath( "org/ops4j/util/collections/multiplevaluesproperty.ini" ),
            m_file,
            true
        );
    }
        ...
        throws IOException
    {
        ...
        compareFiles(
            FileUtils.getFileFromClasspath( "org/ops4j/util/collections/rawproperty.ini" ),
            m_file,
            true
        );
    }
